...
//import QtGraphicalEffects // Для тени
...
Button {
    ...
    readonly property color normalOuterColor: Constants.buttonSecondaryPressed       // Светло-розовый фон/рамка в обычном состоянии
    readonly property color normalInnerColor: Constants.buttonSecondaryBackground    // Белый внутренний фон в обычном состоянии
    readonly property color hoverBackgroundColor: Constants.buttonSecondaryPressedHover // Лососевый фон при наведении
    readonly property color borderColor: Constants.borderPrimary                     // Коричневая рамка
    readonly property color textColor: Constants.textPrimary                         // Коричневый текст
