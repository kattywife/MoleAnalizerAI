...
Button {
    ...
    readonly property color borderColor: App.Constants.buttonSecondaryBorder // Он же Constants.borderPrimary
    readonly property color textColor: App.Constants.buttonSecondaryText     // Он же Constants.textSecondary
    ...
    readonly property color shadowColor: App.Constants.shadow // Цвет тени из констант
