...
import CancerMoles 1.0 // Модуль с общими компонентами (TopBar, LeftMenuPanel, WorkspacePanel, Constants, Logo, AnalyzeButton)
// import CancerMoles.screens 1.0 // Если мы НЕ в этом модуле, а где-то выше
